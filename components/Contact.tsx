...
const Contact: React.FC<ContactProps> = ({ id }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fetch("https://formspree.io/f/mpwrpdlo", {
      method: "POST",
  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-12 items-start">
        <div>
          <h3 className="text-2xl font-semibold mb-4 text-lighttext dark:text-darktext">
            Let's Connect
          </h3>
          ...
          <div className="flex space-x-4">
            <a
              ...
              className="text-slate-500 hover:text-primary dark:text-slate-400 dark:hover:text-primary-light transition-colors p-2 bg-slate-200 dark:bg-slate-700 rounded-full"
            >
        ...
        {isSubmitted ? (
          <div
            className="bg-green-100 dark:bg-green-900 border border-green-400 dark:border-green-600 text-green-700 dark:text-green-200 px-4 py-3 rounded-lg relative"
            role="alert"
          >
          ...
          <form
            ...
            className="space-y-6 bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-lg shadow-xl"
          >
            <div>
              <label
                htmlFor="name"
              ...
              <input
                ...
                } rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-slate-700 dark:text-white sm:text-sm`}
              />
              {errors.name && (
