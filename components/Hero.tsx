...
const Hero: React.FC<HeroProps> = ({ id }) => {
  return (
    <Section id={id} className="min-h-screen flex items-center bg-gradient-to-br from-slate-100 to-sky-100 dark:from-slate-800 dark:to-sky-900 !py-0">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl text-center">
        ...
        <div className="flex justify-center space-x-6">
          ...
          <a href={`mailto:${SOCIAL_LINKS.email}`} className="text-slate-500 hover:text-primary dark:text-slate-400 dark:hover:text-primary-light transition-colors duration-300">
